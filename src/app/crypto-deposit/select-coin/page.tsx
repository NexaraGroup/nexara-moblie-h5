...
const PageCryptoDepositSelectCoin = () => {
	...
	const handleSelectToken = (index: number) => {
		...
		router.push(
			`/crypto-deposit/select-network?tokenId=${tokenId}&tokenName=${tokenName}&blockChainList=${JSON.stringify(blockChainList)}`,
		);
	};
...
export default PageCryptoDepositSelectCoin;
